...
function Home() {
  return (
    ...
    <div className="relative z-10 w-full flex justify-center">
      <div className="w-full max-w-screen-4xl bg-white py-12 px-12 shadow-2xl overflow-hidden">
          {/* --- INNER WHITE PANEL --- */}
          <div className="relative z-10 w-full max-w-screen-2xl flex flex-col items-center bg-white py-12 px-6 shadow-2xl">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl mx-auto gap-10 mt-4">
              ...
              {/* Model Wrapper */}
              <div className="w-full md:w-1/3 flex justify-center relative overflow-hidden bg-white retro-pixel-text">
            ...
            {/* Description */}
            <div className="w-full mt-2 relative z-10 max-w-7xl mx-auto">
              <HomepageDescription />
            </div>
